...
data['nTrainSamples'] = 99500
data['nTestSamples'] = 500
data['nEpochs'] = 100
data['gamma'] = 0.95
data['lrSteps'] = 10 
data['channel_dimension'] = 20
data['embedding_dimension'] = 128
data['summaryFile'] = "comparison_file.txt"
...
for ii in [1, 4, 16, 21, 24]:
    ...
    for lr in [0.01, 0.001, 0.0001]:
        ...
        for bs in [16, 32, 64, 128]:
            ...
            data['batchSize'] = bs
            name = "permutation_equivariant_new_lba_file_"+str(ii+1)+"_lr_"+str(lr)+"_bs_"+str(bs)+".json"
