...
class _DoubleEmbedding(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # G6 = self._res_module_2(G6 + d1)
        
        # [1,4,2,3,5],

        G7 = self._res_module_2(d03 + d12 + d4) 
        # G7 = self._res_module_2(G7 + d4)
        
        # [1,4,2,5,3],

        G8 = self._res_module_2(d03 + d14 + d2) 
        # G8 = self._res_module_2(G8 + d2)
        
        # [1,4,3,5,2],

        G9 = self._res_module_2(d03 + d24 + d1) 
        # G9 = self._res_module_2(G9 + d1)
        ...
        # G11 = self._res_module_2(G11 + d2)
        
        # [1,5,3,4,2],

        G12 = self._res_module_2(d04 + d23 + d1)
        # G12 = self._res_module_2(G12 + d1)
        
        # [2,3,4,5,1],

        G13 = self._res_module_2(d04 + d24 + d0)
        # G13 = self._res_module_2(G13 + d0)
        
        # [2,4,3,5,1],

        G14 = self._res_module_2(d13 + d24 + d0)
        # G14 = self._res_module_2(G14 + d0)
        
        # [2,5,3,4,1]

        G15 = self._res_module_2(d14 + d23 + d0) 
        # G15 = self._res_module_2(G15 + d0)
        #Quartet 2 (13|24)
        # d02 = d0 + d2
