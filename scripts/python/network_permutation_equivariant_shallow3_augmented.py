...
##################################################################33
# we specify the transformations to be used
...
##################################################
# we specify the modules to be used
...
for epoch in range(1, n_epochs+1):
    ...
    if epoch % 10 == 0 :
        ...
        if accuracyTest > min_accuracy:
            ...
            torch.save(model.state_dict(), "saved_permutation_model_shallow_augmented_best.pth")


torch.save(model.state_dict(), "saved_permutation_model_shallow_augmented_last.pth")
