...
class _DoubleEmbedding(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        G1 = self._res_module_2(d01 + d23)
        G1 = self._res_module_2(G1 + d4)

        # [1,2,3,5,4],

        G2 = self._res_module_2(d01 + d24) 
        G2 = self._res_module_2(G2 + d3)       

        # [1,2,4,5,3],

        G3 = self._res_module_2(d01 + d34)    
        G3 = self._res_module_2(G3 + d3)
        # [1,3,2,4,5],

        G4 = self._res_module_2(d02 + d13)    
        G4 = self._res_module_2(G4 + d3)

        # [1,3,2,5,4],

        G5 = self._res_module_2(d02 + d14)    
        G5 = self._res_module_2(G5 + d3)

        # [1,3,4,5,2],

        G6 = self._res_module_2(d02 + d34) 
        G6 = self._res_module_2(G6 + d3)
        
        # [1,4,2,3,5],

        G7 = self._res_module_2(d03 + d12) 
        G7 = self._res_module_2(G7 + d3)
        
        # [1,4,2,5,3],

        G8 = self._res_module_2(d03 + d14) 
        G8 = self._res_module_2(G8 + d3)
        
        # [1,4,3,5,2],

        G9 = self._res_module_2(d03 + d24) 
        G9 = self._res_module_2(G9 + d3)
        
        # [1,5,2,3,4],

        G10 = self._res_module_2(d04 + d12) 
        G10 = self._res_module_2(G10 + d3)
        
        # [1,5,2,4,3],

        G11 = self._res_module_2(d04 + d13) 
        G11 = self._res_module_2(G11 + d3)
        
        # [1,5,3,4,2],

        G12 = self._res_module_2(d04 + d23) 
        G12 = self._res_module_2(G12 + d3)
        
        # [2,3,4,5,1],

        G13 = self._res_module_2(d04 + d24) 
        G13 = self._res_module_2(G13 + d3)
        
        # [2,4,3,5,1],

        G14 = self._res_module_2(d13 + d24) 
        G14 = self._res_module_2(G14 + d3)
        
        # [2,5,3,4,1]

        G15 = self._res_module_2(d14 + d23) 
        G15 = self._res_module_2(G15 + d3)
        #Quartet 2 (13|24)
        # d02 = d0 + d2
