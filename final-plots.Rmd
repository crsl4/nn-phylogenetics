...
First, I downloaded the output csv files from the [Google Drive](https://drive.google.com/drive/u/2/folders/1G_ied9kMbcJTt_ZNWWN67SAkggFISNGT) and put inside a folder `phylo-nn-googledrive/outputs/PlotsData/`: `EpochAccuracy1300.csv`, `SixMethodsComparison.csv`.
